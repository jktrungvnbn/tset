...
import BiA.Controller.Service._ServiceMail;
import BiA.Controller.Service._ServiceUser;
    ...
    private void sendMail(ModelNguoiDung user){
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                ModelMessage ms = new _ServiceMail().sendMain(user.getEmail(), user.getVerifyCode());
                if (ms.isSuccess()) {
