...
import View.Dialog.MS_ConfirmExchangeVoucher;
...
public class CardVoucher extends javax.swing.JPanel {
    ...
    public CardVoucher(ModelVoucher data, ModelKhachHang customer, ModelHoaDon hoadon) {
        ...
        cmdExchange.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                int Vpoint = data.getDiem();
                if (hoadon == null) {

                } else {
                    if (customer.getDiemTichLuy() < Vpoint) {
                        warning.WarningExchange(Vpoint - customer.getDiemTichLuy());
                    } else {
    ...
    public void init() {
        ...
        ibDescription.setText(data.getMota());
        lbQuantity.setText("Số lượng: " + data.getSoluong());
        lbPoint.setText(data.getDiem() + " xu");
        switch (data.getPhantram()) {
            case 20 -> {
    ...
    private void initComponents() {
        ...
        cmdExchange = new View.Swing.Button();
    ...
    private View.Swing.Button cmdExchange;
