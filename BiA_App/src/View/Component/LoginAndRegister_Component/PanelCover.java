...
public class PanelCover extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        title= new JLabel("Chào mừng bạn đến với Chúng tôi ");
        title.setFont(new Font("sansserif",1,18));
        title.setForeground(new Color(245,245,245));
        add(title);
        
        subtitle= new JLabel("BI-A VIP");
    ...
    private void login(boolean login){
        if(this.isLogin !=login){
            ...
            if(login){
                ...
                description1.setText("và bắt đầu trải nghiệm của bạn với quán chúng tôi");
                button.setText("Đăng ký  >>");
            }else{
                //Set Data cho Panel cover khi ở màn hình đăng ký
                logo.setIcon(new ImageIcon(getClass().getResource("/Icons/logo_register.png")));
                title.setText("Chào mừng bạn đến với Chúng Tôi");
